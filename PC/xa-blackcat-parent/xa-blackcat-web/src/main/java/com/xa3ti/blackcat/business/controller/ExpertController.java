...
public class ExpertController extends BaseController {
	...
	/**
	 * @Title: 				findExpertNEStatusPage
	 * @Description: 		分页查询Expert	 * @param request		有需要的拿去使用
	 * @param nextPage		页号
	 * @param pageSize		页长
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findExpertNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Expert>> findExpertNEStatusPage(
		...
		//return expertService.findExpertNEStatusByFilter(status, filterParams, pageable);
		...
		ServiceInvocation invocation=new ServiceInvocation(request,"findExpertNEStatusByFilter",paramaterMap,null);
	...
	public XaResult<Page<Expert>> findExpertEQStatusPage(
			HttpServletRequest request,
			@RequestParam(defaultValue = "0") Integer nextPage,
			@RequestParam(defaultValue = "10") Integer pageSize,
	...
	/**
	 * @Title: 			findExpertSelectTypes
	 * @Description: 	获取查询项中需要获取数据字典的操作
	 * @param request	有需要的拿去使用	
	 * @return    		XaResult<T>
	 */
	@ResponseBody
	@RequestMapping(value="findExpertSelectTypes",method=RequestMethod.POST)
	public XaResult<Expert> findExpertSelectTypes(
			HttpServletRequest request
			
		) throws BusinessException{
		return new XaResult<Expert>();
	}
	...
	/**
	 * @Title: 			saveExpert	 * @Description: 	新增一条实体
	 * @param model		对象
	 * @param request	有需要的拿去使用	
	 * @return    		XaResult<T>
	 */
	...
	public XaResult<Expert> saveExpert(
		 		  ...
		 		  @RequestParam(value = "district"   , required = false ) String district,
		 				 		  ...
		 				 		  @RequestParam(value = "socialFunction"   , required = false ) String socialFunction,
		...
		XaResult<Expert> xa=new XaResult<Expert> ();
		//xa.setObject((Expert) Encriptor.decriptModelByTokenType(x.getObject(), t.getType()));
		xa.setObject(x.getObject());

		return xa;
		//return expertService.createExpert(userId,model);
	}
	...
	public XaResult<Expert> updateExpert(
		...
		//return expertService.updateExpert(userId,model);
	}
	...
	public XaResult<Expert> operateExpertById(
		...
		return x;
		//return expertService.operateExpert(userId,modelId,status);
	}
	
	/**
	 * @Title: 				multiOperateExpertByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateExpertByIds",method=RequestMethod.POST)
	public XaResult<Expert> operateExpertByIds(
			HttpServletRequest request,
		...
		ServiceInvocation invocation=new ServiceInvocation(request,"multiOperateExpert",paramaterMap,null);
		ServiceInvoker invoker=new ServiceInvoker(expertService);
		Result r=invoker.invoke(invocation);
		...
		//return expertService.multiOperateExpert(userId,modelIds,status);
	}
