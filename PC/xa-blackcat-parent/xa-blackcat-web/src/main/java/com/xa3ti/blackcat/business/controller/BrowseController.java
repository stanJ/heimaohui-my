...
public class BrowseController extends BaseController {
	...
	/**
	 * @Title: 				findBrowseNEStatusPage
	 * @Description: 		分页查询Browse	 * @param request		有需要的拿去使用
	 * @param nextPage		页号
	 * @param pageSize		页长
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findBrowseNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Browse>> findBrowseNEStatusPage(
		...
		//return browseService.findBrowseNEStatusByFilter(status, filterParams, pageable);
		...
		ServiceInvocation invocation=new ServiceInvocation(request,"findBrowseNEStatusByFilter",paramaterMap,null);
	...
	/**
	 * @Title: 			findBrowseSelectTypes
	 * @Description: 	获取查询项中需要获取数据字典的操作
	 * @param request	有需要的拿去使用	
	 * @return    		XaResult<T>
	 */
	@ResponseBody
	@RequestMapping(value="findBrowseSelectTypes",method=RequestMethod.POST)
	public XaResult<Browse> findBrowseSelectTypes(
			HttpServletRequest request
			
		) throws BusinessException{
		return new XaResult<Browse>();
	}
	...
	/**
	 * @Title: 			saveBrowse	 * @Description: 	新增一条实体
	 * @param model		对象
	 * @param request	有需要的拿去使用	
	 * @return    		XaResult<T>
	 */
	...
	public XaResult<Browse> saveBrowse(
				 		  @RequestParam(value = "userId"  ) String userId,
		 				 		  @RequestParam(value = "btime"  ) Date btime,
		...
		XaResult<Browse> xa=new XaResult<Browse> ();
	 	xa.setObject(x.getObject());
		return xa; 				 			
		//return browseService.createBrowse(userId,model);
	}
	...
	public XaResult<Browse> updateBrowse(
		...
		//return browseService.updateBrowse(userId,model);
	}
	...
	public XaResult<Browse> operateBrowseById(
		...
		return x;
		//return browseService.operateBrowse(userId,modelId,status);
	}
	
	/**
	 * @Title: 				multiOperateBrowseByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateBrowseByIds",method=RequestMethod.POST)
	public XaResult<Browse> operateBrowseByIds(
			HttpServletRequest request,
		...
		ServiceInvocation invocation=new ServiceInvocation(request,"multiOperateBrowse",paramaterMap,null);
		ServiceInvoker invoker=new ServiceInvoker(browseService);
		Result r=invoker.invoke(invocation);
		...
		//return browseService.multiOperateBrowse(userId,modelIds,status);
	}
