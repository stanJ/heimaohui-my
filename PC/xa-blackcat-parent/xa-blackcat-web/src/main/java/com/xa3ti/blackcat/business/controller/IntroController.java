...
public class IntroController extends BaseController {
	...
	/**
	 * @Title: 				findIntroNEStatusPage
	 * @Description: 		分页查询Intro	 * @param request		有需要的拿去使用
	 * @param nextPage		页号
	 * @param pageSize		页长
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findIntroNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Intro>> findIntroNEStatusPage(
		...
		//return introService.findIntroNEStatusByFilter(status, filterParams, pageable);
		...
		ServiceInvocation invocation=new ServiceInvocation(request,"findIntroNEStatusByFilter",paramaterMap,null);
	...
	/**
	 * @Title: 			findIntroSelectTypes
	 * @Description: 	获取查询项中需要获取数据字典的操作
	 * @param request	有需要的拿去使用	
	 * @return    		XaResult<T>
	 */
	@ResponseBody
	@RequestMapping(value="findIntroSelectTypes",method=RequestMethod.POST)
	public XaResult<Intro> findIntroSelectTypes(
			HttpServletRequest request
			
		) throws BusinessException{
		return new XaResult<Intro>();
	}
	...
	/**
	 * @Title: 			saveIntro	 * @Description: 	新增一条实体
	 * @param model		对象
	 * @param request	有需要的拿去使用	
	 * @return    		XaResult<T>
	 */
	...
	public XaResult<Intro> saveIntro(
				 		  @RequestParam(value = "fileName"  ) String fileName,
		 				 		  @RequestParam(value = "uptime"  ) Date uptime,
		...
		XaResult<Intro> xa=new XaResult<Intro> ();
	 	xa.setObject(x.getObject());
		return xa; 				 			
		//return introService.createIntro(userId,model);
	}
	...
	public XaResult<Intro> updateIntro(
		...
		//return introService.updateIntro(userId,model);
	}
	...
	public XaResult<Intro> operateIntroById(
		...
		return x;
		//return introService.operateIntro(userId,modelId,status);
	}
	
	/**
	 * @Title: 				multiOperateIntroByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateIntroByIds",method=RequestMethod.POST)
	public XaResult<Intro> operateIntroByIds(
			HttpServletRequest request,
		...
		ServiceInvocation invocation=new ServiceInvocation(request,"multiOperateIntro",paramaterMap,null);
		ServiceInvoker invoker=new ServiceInvoker(introService);
		Result r=invoker.invoke(invocation);
		...
		//return introService.multiOperateIntro(userId,modelIds,status);
	}
