...
public class NewsController extends BaseController {
	...
	/**
	 * @Title: 				findNewsNEStatusPage
	 * @Description: 		分页查询News	 * @param request		有需要的拿去使用
	 * @param nextPage		页号
	 * @param pageSize		页长
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findNewsNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<News>> findNewsNEStatusPage(
		...
		//return newsService.findNewsNEStatusByFilter(status, filterParams, pageable);
		...
		ServiceInvocation invocation=new ServiceInvocation(request,"findNewsNEStatusByFilter",paramaterMap,null);
	...
	/**
	 * @Title: 			findNewsSelectTypes
	 * @Description: 	获取查询项中需要获取数据字典的操作
	 * @param request	有需要的拿去使用	
	 * @return    		XaResult<T>
	 */
	@ResponseBody
	@RequestMapping(value="findNewsSelectTypes",method=RequestMethod.POST)
	public XaResult<News> findNewsSelectTypes(
			HttpServletRequest request
			
		) throws BusinessException{
		return new XaResult<News>();
	}
	...
	/**
	 * @Title: 			saveNews	 * @Description: 	新增一条实体
	 * @param model		对象
	 * @param request	有需要的拿去使用	
	 * @return    		XaResult<T>
	 */
	...
	public XaResult<News> saveNews(
		...
		XaResult<News> xa=new XaResult<News> ();
	 	xa.setObject(x.getObject());
		return xa; 				 			
		//return newsService.createNews(userId,model);
	}
	...
	public XaResult<News> updateNews(
		...
		//return newsService.updateNews(userId,model);
	}
	...
	public XaResult<News> operateNewsById(
		...
		return x;
		//return newsService.operateNews(userId,modelId,status);
	}
	
	/**
	 * @Title: 				multiOperateNewsByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateNewsByIds",method=RequestMethod.POST)
	public XaResult<News> operateNewsByIds(
			HttpServletRequest request,
		...
		ServiceInvocation invocation=new ServiceInvocation(request,"multiOperateNews",paramaterMap,null);
		ServiceInvoker invoker=new ServiceInvoker(newsService);
		Result r=invoker.invoke(invocation);
		...
		//return newsService.multiOperateNews(userId,modelIds,status);
	}
