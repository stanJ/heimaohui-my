...
<html>
        ...
        <script type="text/javascript">
        	...
        	function displayContent(){
				...
				/************************拼装查询条件************************************/
					...
					_jsonFilter += "'search_EQ_fdate':'"+fdate+"',";
				}
				...
				_jsonFilter += "}";
				var url = "../cms/feedback/findFeedbackNEStatusPage";
				$.ajax({
					url:url,
					dataType:'json',
					type:'POST',
			...
			$(function(){
				...
				$("#updateSome").click(function(){
					...
					rememberRecord();
					var url = "feedbackEdit.jsp?id="+updateArray[0];
			    	window.location.href=url;
				});
				...
				$("#deleteSome").click(function() {
                    ...
                    if(confirm("你确定要删除选中项吗？")){
                    	var url="../cms/feedback/operateFeedbackByIds?modelIds=" + delArray.join(",")+"&token="+encodeURIComponent(token);
                    	$.ajax({
							url: url,
							type: 'post',
							dataType: 'json',
				...
				$("#lockSome").click(function() {
                    ...
                    if(confirm("你确定要锁定选中项吗？")){
                    	var url="../cms/feedback/operateFeedbackByIds";
                    	$.ajax({
							url: url,
							type: 'post',
							data:{
    ...
    <body>
    <input type="hidden" id="currentModel" value="Feedback" />
		<section>
			<div class="col-xs-12">
				<div class="box">
					<div class="span1">
						<span class="badge badge-info">XXXX   &gt; 意见反馈管理</span>
					</div>
