...
<html>
    <head>
        ...
        <script type="text/javascript">
        	...
        	function displayContent(){
				...
				_jsonFilter += "}";
				var url = "../cms/expertCategory/findExpertCategoryNEStatusPage";
				$.ajax({
					url:url,
					dataType:'json',
					type:'POST',
			...
			$(function(){
				...
				$("#addSome").click(function(){
					rememberRecord();
					var url = "expertCategoryEdit.jsp";
				...
				$("#updateSome").click(function(){
					...
					rememberRecord();
					var url = "expertCategoryEdit.jsp?id="+updateArray[0];
			    	window.location.href=url;
				});
				...
				$("#deleteSome").click(function() {
                    ...
                    if(confirm("你确定要删除选中项吗？")){
                    	var url="../cms/expertCategory/operateExpertCategoryByIds?modelIds=" + delArray.join(",")+"&token="+encodeURIComponent(token);;
                    	$.ajax({
							url: url,
							type: 'post',
							dataType: 'json',
				...
				$("#lockSome").click(function() {
                    ...
                    if(confirm("你确定要锁定选中项吗？")){
                    	var url="../cms/expertCategory/operateExpertCategoryByIds";
                    	$.ajax({
							url: url,
							type: 'post',
							data:{
    ...
    <body>
    <input type="hidden" id="currentModel" value="ExpertCategory" />
		<section>
			<div class="col-xs-12">
				<div class="box">
					<div class="span1">
						<span class="badge badge-info">XXXX   &gt; 专家类别管理</span>
					</div>
