							...
							if(data.code == 1){
								/********************加载数据*****************************/
								  									$("#customerId").val(data.object.customerId);
								     									...
								     									$("#linker").val(data.object.linker);
								     									$("#expertName").val(data.object.expertName);
				...
				$("#demo_31").validator({
					valid:function(form){
						...
						if(typeof(tid)=="undefined" || tid == "" || tid == "0"){
							//新增
							tid = 0;
							submit_url = "../cms/work/saveWork";
						}
						else{
							submit_url = "../cms/work/updateWork";
						}
			        	/** 富文本操作预留,如需要可打开此注释
    ...
    <body>
    	<section>
      	<form id="demo_31" class="form-inline">
        	<div class="col-xs-12">
				<div class="span1">
					<span class="badge badge-info">XX管理    &gt; 合作记录管理    &gt;  合作记录编辑</span>
				</div>
              	<div class="box">
					<div class="box-header">
						<br>
							<input type="button" value="确定" id="saveOrupdate" class="btn btn-success">
							<a href="#" onclick="document.location.href='workList.jsp';" class="btn btn-info" >返回</a>
					</div>
					<div class="tab" id="usercontent">
						...
						<fieldset>
								...
								<input type="text" placeholder="请填写序号" data-rule="序号:required;length[0~10]" id="serial" name="serial" value="" />
								  								...
								  								<li class="controls">对接人:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写对接人" data-rule="对接人:required;length[0~10]" id="linker" name="linker" value="" />
								</li>
								  								<li class="controls">专家名称:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写专家名称" data-rule="专家名称:required;length[0~20]" id="expertName" name="expertName" value="" />
								</li>
								  								<li class="controls">活动时间:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写活动时间" data-rule="length[0~10]" id="actionDate" name="actionDate" value="" />
								</li>
								  								<li class="controls">活动地点:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写活动地点" data-rule="length[0~10]" id="actionAddress" name="actionAddress" value="" />
								</li>
								  								<li class="controls">评价:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写评价" data-rule="length[0~10]" id="comment" name="comment" value="" />
								</li>
