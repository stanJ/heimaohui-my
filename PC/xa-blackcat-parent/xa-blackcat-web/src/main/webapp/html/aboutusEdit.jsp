    ...
    <body>
    	<section>
      	<form id="demo_31" class="form-inline">
        	<div class="col-xs-12">
				<div class="span1">
					<span class="badge badge-info">XX管理    &gt; 关于我们管理    &gt;  关于我们编辑</span>
				</div>
              	<div class="box">
					<div class="box-header">
						<br>
							<input type="button" value="确定" id="saveOrupdate" class="btn btn-success">
							<a href="#" onclick="document.location.href='aboutusList.jsp';" class="btn btn-info" >返回</a>
					</div>
					<div class="tab" id="usercontent">
						<input type="hidden" id="tid"/>
						<fieldset>
						     								 								<li class="controls">Logo:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写Logo" data-rule="length[0~500]" id="logo" name="logo" value="" />
								</li>
								  								<li class="controls">轮播图:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写轮播图" data-rule="length[0~2000]" id="pics" name="pics" value="" />
								</li>
								  								<li class="controls">版本号:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写版本号" data-rule="length[0~50]" id="versionno" name="versionno" value="" />
								</li>
								  								<li class="controls">电话:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写电话" data-rule="length[0~50]" id="tel" name="tel" value="" />
								</li>
								  								<li class="controls">内容:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写内容" data-rule="length[0~2000]" id="content" name="content" value="" />
								</li>
								 						</fieldset>
						<br/>
					</div>
