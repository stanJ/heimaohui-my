				...
				$("#demo_31").validator({
					valid:function(form){
						...
						if(typeof(tid)=="undefined" || tid == "" || tid == "0"){
							//新增
							tid = 0;
							submit_url = "../cms/news/saveNews";
						}
						else{
							submit_url = "../cms/news/updateNews";
						}
			        	/** 富文本操作预留,如需要可打开此注释
              	...
              	<div class="box">
					<div class="box-header">
						<br>
							...
							<a href="#" onclick="document.location.href='newsList.jsp';" class="btn btn-info" >返回</a>
					</div>
					<div class="tab" id="usercontent">
						...
						<fieldset>
								...
								<input type="text" placeholder="请填写内容" data-rule="内容:required;length[0~40]" id="content" name="content" value="" />
								</li>
								 						</fieldset>
						<br/>
					</div>
