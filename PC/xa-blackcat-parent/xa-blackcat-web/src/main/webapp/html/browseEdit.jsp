    ...
    <head>
        ...
        <script type="text/javascript">
			...
			$(function(){
				...
				$("#tid").val(tid);
				var url ='../cms/browse/findBrowseById';
				...
				$("#demo_31").validator({
					valid:function(form){
						...
						if(typeof(tid)=="undefined" || tid == "" || tid == "0"){
							//新增
							tid = 0;
							submit_url = "../cms/browse/saveBrowse";
						}
						else{
							submit_url = "../cms/browse/updateBrowse";
						}
			        	/** 富文本操作预留,如需要可打开此注释
						...
						$.ajax({
							...
							success:function(data){
								if(data.code==1){
									window.location.href="browseList.jsp";
								}
								else{
									alert(data.message);
								}
    ...
    <body>
    	<section>
      	<form id="demo_31" class="form-inline">
        	<div class="col-xs-12">
				<div class="span1">
					<span class="badge badge-info">XX管理    &gt; 浏览记录管理    &gt;  浏览记录编辑</span>
				</div>
              	<div class="box">
					<div class="box-header">
						<br>
							<input type="button" value="确定" id="saveOrupdate" class="btn btn-success">
							<a href="#" onclick="document.location.href='browseList.jsp';" class="btn btn-info" >返回</a>
					</div>
					<div class="tab" id="usercontent">
						<input type="hidden" id="tid"/>
						<fieldset>
						   								 								<li class="controls">账号:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写账号" data-rule="账号:required;length[0~32]" id="userId" name="userId" value="" />
								</li>
								  								<li class="controls">浏览时间:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写浏览时间" data-rule="浏览时间:required;length[0~10]" id="btime" name="btime" value="" />
								</li>
