    ...
    <head>
        ...
        <script type="text/javascript">
			...
			$(function(){
				...
				$("#tid").val(tid);
				var url ='../cms/customer/findCustomerById';
							...
							if(data.code == 1){
								/********************加载数据*****************************/
								  									$("#name").val(data.object.name);
								     									$("#manager").val(data.object.manager);
								 									...
								 									$("#district").val(data.object.district);
								     									...
								     									$("#serviceArea").val(data.object.serviceArea);
								     									$("#serviceObject").val(data.object.serviceObject);
								     									$("#intro").val(data.object.intro);
								     									$("#file").val(data.object.file);
								   								/********************加载数据*****************************/
								/********************加载字典数据*****************************/
								                      								/********************加载字典数据*****************************/
							}else{
				...
				$("#demo_31").validator({
					valid:function(form){
						...
						if(typeof(tid)=="undefined" || tid == "" || tid == "0"){
							//新增
							tid = 0;
							submit_url = "../cms/customer/saveCustomer";
						}
						else{
							submit_url = "../cms/customer/updateCustomer";
						}
			        	/** 富文本操作预留,如需要可打开此注释
    ...
    <body>
    	<section>
      	<form id="demo_31" class="form-inline">
        	<div class="col-xs-12">
				<div class="span1">
					<span class="badge badge-info">XX管理    &gt; 客户管理    &gt;  客户编辑</span>
				</div>
              	<div class="box">
					<div class="box-header">
						<br>
							<input type="button" value="确定" id="saveOrupdate" class="btn btn-success">
							<a href="#" onclick="document.location.href='customerList.jsp';" class="btn btn-info" >返回</a>
					</div>
					<div class="tab" id="usercontent">
						...
						<fieldset>
								...
								<input type="text" placeholder="请填写名称" data-rule="名称:required;length[0~200]" id="name" name="name" value="" />
								</li>
								  								<li class="controls">公司负责人:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写公司负责人" data-rule="length[0~50]" id="manager" name="manager" value="" />
								</li>
								...
								<input type="text" placeholder="请填写微信" data-rule="length[0~50]" id="wechat" name="wechat" value="" />
								  								...
								  								<li class="controls">所在省市:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写所在省市" data-rule="length[0~10]" id="province,city,district" name="province,city,district" value="" />
								</li>
								  								<li class="controls">客户评价:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写客户评价" data-rule="length[0~20]" id="comment" name="comment" value="" />
								</li>
								  								<li class="controls">服务地区:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写服务地区" data-rule="length[0~20]" id="serviceArea" name="serviceArea" value="" />
								</li>
								  								<li class="controls">服务对象:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写服务对象" data-rule="length[0~20]" id="serviceObject" name="serviceObject" value="" />
								</li>
								  								<li class="controls">公司简介:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写公司简介" data-rule="length[0~100]" id="intro" name="intro" value="" />
								</li>
								  								<li class="controls">附件:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写附件" data-rule="length[0~200]" id="file" name="file" value="" />
								</li>
								 						</fieldset>
						<br/>
					</div>
