    ...
    <head>
        ...
        <script type="text/javascript">
			...
			$(function(){
				...
				$("#tid").val(tid);
				var url ='../cms/feedback/findFeedbackById';
				...
				$("#demo_31").validator({
					valid:function(form){
						...
						if(typeof(tid)=="undefined" || tid == "" || tid == "0"){
							//新增
							tid = 0;
							submit_url = "../cms/feedback/saveFeedback";
						}
						else{
							submit_url = "../cms/feedback/updateFeedback";
						}
			        	/** 富文本操作预留,如需要可打开此注释
    ...
    <body>
    	<section>
      	<form id="demo_31" class="form-inline">
        	<div class="col-xs-12">
				<div class="span1">
					<span class="badge badge-info">XX管理    &gt; 意见反馈管理    &gt;  意见反馈编辑</span>
				</div>
              	<div class="box">
					<div class="box-header">
						<br>
							<input type="button" value="确定" id="saveOrupdate" class="btn btn-success">
							<a href="#" onclick="document.location.href='feedbackList.jsp';" class="btn btn-info" >返回</a>
					</div>
					<div class="tab" id="usercontent">
						<input type="hidden" id="tid"/>
						<fieldset>
						   								 								<li class="controls">用户Id:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写用户Id" data-rule="length[0~10]" id="userId" name="userId" value="" />
								</li>
								  								<li class="controls">反馈时间:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写反馈时间" data-rule="反馈时间:required;length[0~20]" id="fdate" name="fdate" value="" />
								</li>
								  								<li class="controls">反馈内容:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写反馈内容" data-rule="反馈内容:required;length[0~2000]" id="content" name="content" value="" />
								</li>
								 						</fieldset>
						<br/>
					</div>
