    ...
    <head>
        ...
        <script type="text/javascript">
			...
			$(function(){
				...
				$("#tid").val(tid);
				var url ='../cms/intro/findIntroById';
				...
				$("#demo_31").validator({
					valid:function(form){
						...
						if(typeof(tid)=="undefined" || tid == "" || tid == "0"){
							//新增
							tid = 0;
							submit_url = "../cms/intro/saveIntro";
						}
						else{
							submit_url = "../cms/intro/updateIntro";
						}
			        	/** 富文本操作预留,如需要可打开此注释
						...
						$.ajax({
							...
							success:function(data){
								if(data.code==1){
									window.location.href="introList.jsp";
								}
								else{
									alert(data.message);
								}
    ...
    <body>
    	<section>
      	<form id="demo_31" class="form-inline">
        	<div class="col-xs-12">
				<div class="span1">
					<span class="badge badge-info">XX管理    &gt; 公司简介管理    &gt;  公司简介编辑</span>
				</div>
              	<div class="box">
					<div class="box-header">
						<br>
							<input type="button" value="确定" id="saveOrupdate" class="btn btn-success">
							<a href="#" onclick="document.location.href='introList.jsp';" class="btn btn-info" >返回</a>
					</div>
					<div class="tab" id="usercontent">
						<input type="hidden" id="tid"/>
						<fieldset>
						   								 								<li class="controls">文件名称:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写文件名称" data-rule="文件名称:required;length[0~50]" id="fileName" name="fileName" value="" />
								</li>
								  								<li class="controls">上传时间:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写上传时间" data-rule="上传时间:required;length[0~10]" id="uptime" name="uptime" value="" />
								</li>
								  								<li class="controls">文件路径:</li>
								<li style="width:300px;text-align:left;">
								<input type="text" placeholder="请填写文件路径" data-rule="文件路径:required;length[0~200]" id="filePath" name="filePath" value="" />
								</li>
								 						</fieldset>
						<br/>
					</div>
