...
public class TokenEndpoint extends AbstractEndpoint {
	...
	@ResponseBody
	public XaResult<OAuth2AccessToken> getAccessToken(Principal principal, @RequestParam
...
//		return getResponse(token);
		...
		XaResult<OAuth2AccessToken> xaResult = new XaResult<OAuth2AccessToken>();
		xaResult.setObject(token);
		return xaResult;
	}
	...
	@ResponseBody
	public XaResult<OAuth2Exception> handleClientRegistrationException(Exception e) throws Exception {
		logger.info("Handling error: " + e.getClass().getSimpleName() + ", " + e.getMessage());
//		return getExceptionTranslator().translate(new BadClientCredentialsException());
		//zj 修改自定义异常输出
		XaResult<OAuth2Exception> xaResult = new XaResult<OAuth2Exception>();
		xaResult.setCode(XaConstant.Code.code_failure_token);
		xaResult.setMessage(e.getMessage());
		return xaResult;
	}

	@ExceptionHandler(OAuth2Exception.class)
	@ResponseBody
	public XaResult<OAuth2Exception> handleException(Exception e) throws Exception {
		logger.info("Handling error: " + e.getClass().getSimpleName() + ", " + e.getMessage());
