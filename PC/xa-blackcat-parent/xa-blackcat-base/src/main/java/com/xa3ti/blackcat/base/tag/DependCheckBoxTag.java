 ...
 *
 */
public class DependCheckBoxTag extends BaseTag implements Tag {
	public static Logger  log = Logger.getLogger(DependCheckBoxTag.class);
	...
	public int doEndTag() throws JspException {
		try {
            ...
            ///////////////////////////////////////////////
			/*
			String key=tableName+"."+codePropertyName;
			int index=0;
			if (list != null) {
				Map<String,String> map=new ConcurrentHashMap<String,String>();
				for (int i = 0; i < list.size(); i++) {
					Object[] onerow = list.get(i);
					String code = String.valueOf(onerow[0]);
					String value = String.valueOf(onerow[1]);
					//strBuffer.append("&nbsp;&nbsp;");
					strBuffer.append(value+"");
					strBuffer.append("<input type='checkbox' id='"+id+"_"+index+"' name='"+super.getName()+"' value='"+code+"'/>\n");
					index++;
