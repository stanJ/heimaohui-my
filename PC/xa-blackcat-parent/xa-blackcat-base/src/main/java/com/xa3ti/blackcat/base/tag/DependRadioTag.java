 ...
 *
 */
public class DependRadioTag extends BaseTag implements Tag {
	public static Logger  log = Logger.getLogger(DependRadioTag.class);
		...
		try {
			...
			if (list != null) {
				...
				for (int i = 0; i < list.size(); i++) {
					...
					//strBuffer.append("&nbsp;&nbsp;");
					strBuffer.append("<input type='radio' id='"+id+"_"+index+"' name='"+super.getName()+"' value='"+code+"'/>\n");
