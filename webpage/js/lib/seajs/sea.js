...
app.pageName=location.pathname.substring(location.pathname.lastIndexOf("/")+1,location.pathname.lastIndexOf(".html"));

if(sessionStorage.getItem("needchangepwd") && app.pageName!="login" && app.pageName!="change_password"){
	location.href="../page/change_password.html";
}

var reg = /.*(?=\/page\/|\/js\/|\/css\/)/;
app.host= location.href.match(reg);
if(app.host.length>0) app.host=app.host[0];
else app.host=".";

app.seaAlias = {
	'jquery':'mylib/jquery/jquery-3.1.1.js',
	'template':'mylib/template/template.js',
	'echarts':'mylib/echarts/echarts.common.min.js',
	'jstree':'mylib/jstree/jstree.js',
	'sui':'mylib/sui/sui.js',
	'datatables':'mylib/datatables/datatables.js',
	'moment':'mylib/moment/moment.js',
//	'datatables':'//cdn.bootcss.com/datatables/1.10.13/js/jquery.dataTables.js',
	'util':'mylib/frame/util.js',
	'frame':'mylib/frame/frame.js',
	'service':'mylib/frame/service.js',
	'table2excel':'mylib/table2excel/jquery.table2excel.js',
	'cookie':'mylib/cookie/js.cookie.js',
	'underscore':'mylib/underscore/underscore.js',
...
app.seaPath={
	mycss:app.host+"/css",
	myjs:app.host+"/js",
	mypage:app.host+"/page",
	mylib:app.host+"/js/lib",
};
...
var loadcss=["mylib/sui/sui.css","mylib/sui/sui-append.css","mylib/datatables/datatables.css","mycss/frame.css","mycss/"+app.pageName+".css"];//,"mycss/"+app.pageName+".css"

seajs.use(loadcss,function(){
	document.querySelector("body").style.display="inherit";
//	seajs.use(['jquery','template','sui',"util"],function(){
//		seajs.use("myjs/"+app.pageName+".js");
//	});
	seajs.use(['jquery','template'],function(){
		seajs.use(['sui','util','service'],function(){
			seajs.use(['datatables','frame','moment','echarts','underscore'],function(){
				seajs.use("myjs/"+app.pageName+".js");
			});
		})
	});
...
//app.clientHeight=document.documentElement.clientHeight;
app.pagesize=20;
var page={};
